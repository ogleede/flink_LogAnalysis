...
//        DataStream<String> inputStream = env.readTextFile(resource.getPath());
        ...
        DataStream<ApacheLogEvent> dataStream = inputStream
                ...
                .assignTimestampsAndWatermarks(new BoundedOutOfOrdernessTimestampExtractor<ApacheLogEvent>(Time.minutes(1)) {//延迟时间
                    @Override
...
////                .keyBy("url")//利用字段，返回的是Tuple
//                .keyBy(ApacheLogEvent::getUrl)//方法引用，直接返回String
...
//                .aggregate(new PageCountAgg(), new PageCountResult());
        ...
        SingleOutputStreamOperator<PageViewCount> windowAggStream = dataStream
                ...
                .filter(data -> {
                    String regex = "^((?!\\.(css|js|png|ico)$).)*$";//过滤资源访问
