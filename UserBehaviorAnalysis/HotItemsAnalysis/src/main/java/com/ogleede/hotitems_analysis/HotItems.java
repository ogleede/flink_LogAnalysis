package com.ogleede.hotitems_analysis;

import com.ogleede.hotitems_analysis.beans.ItemViewCount;
import com.ogleede.hotitems_analysis.beans.UserBehavior;
...
public class HotItems {
    public static void main(String[] args) throws Exception {
        ...
        // 2. 读取数据，创建DataStream
//        DataStream<String> inputStream = env.readTextFile("/Users/ogleede/Documents/Java_codes/UserBehaviorAnalysis/HotItemsAnalysis/src/main/resources/UserBehavior.csv");

        Properties properties = new Properties();
        properties.setProperty("bootstrap.servers", "hadoop1:9092,hadoop2:9092");
//        properties.setProperty("bootstrap.servers", "localhost:9092");
        ...
        DataStream<UserBehavior> dataStream = inputStream
                ...
                .assignTimestampsAndWatermarks(new AscendingTimestampExtractor<UserBehavior>() {
                    @Override
                    public long extractAscendingTimestamp(UserBehavior element) {//ETL后时间戳是升序排列的
                        return element.getTimestamp() * 1000L;
                    }
                });

        // 4. 分组开窗聚合，得到每个窗口内各个商品的浏览量的count值
    ...
    public static class WindowItemCountResult implements WindowFunction<Long, ItemViewCount, Tuple, TimeWindow> {
        ...
        public void apply(Tuple tuple, TimeWindow window, Iterable<Long> input, Collector<ItemViewCount> out) throws Exception {
            ...
            Long count = input.iterator().next();//输出为迭代器，但是wc只有一个数据
